...
% --- START OF BORDER CODE ---
    ...
    \begin{center}
        ...
        % VTU LOGO
        \includegraphics[width=3.5cm]{media/vtu_logo.png} \\[0.5cm]
        ...
        % COLLEGE LOGO
        \includegraphics[width=3.5cm]{media/bmsit_logo.png} \\[0.3cm]
...
\begin{center}
    ...
    \includegraphics[width=3cm]{media/bmsit_logo.png} \\[0.2cm]
